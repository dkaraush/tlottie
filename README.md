...
- Zero dependencies[^1].
- SIMD on NEON and WASM: [web demo](https://dkaraush.github.io/tlottie/examples/web/).
...
Frame time, mainly compared to [rlottie2019](https://github.com/Samsung/rlottie).
